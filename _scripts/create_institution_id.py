...
json_url = "https://raw.githubusercontent.com/WCRP-CORDEX/cordex-cmip6-cv/refs/heads/main/CORDEX-CMIP6_institution_id.json"

# Directory where the JSON files will be saved
save_dir = "CORDEX-CMIP6_institution_id"
...
data = fetch_json(json_url)["institution_id"]
