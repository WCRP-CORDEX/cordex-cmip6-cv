...
json_url = "https://raw.githubusercontent.com/WCRP-CORDEX/cordex-cmip6-cv/refs/heads/main/CORDEX-CMIP6_source_type.json"

# Directory where the JSON files will be saved
save_dir = "CORDEX-CMIP6_source_type"
...
known_sources_in_universe = ev.get_all_terms_in_data_descriptor("source_type")
