...
json_url = "https://raw.githubusercontent.com/WCRP-CORDEX/cordex-cmip6-cv/refs/heads/main/CORDEX-CMIP6_driving_institution_id.json"

# Directory where the JSON files will be saved
save_dir = "CORDEX-CMIP6_driving_institution_id"
...
data = fetch_json(json_url)["driving_institution_id"]

known_institutions_in_universe = ev.get_all_terms_in_data_descriptor("institution")
print(known_institutions_in_universe)
for item in data:
    found_inst = None
