...
json_url = "https://raw.githubusercontent.com/WCRP-CORDEX/cordex-cmip6-cv/refs/heads/main/CORDEX-CMIP6_driving_source_id.json"

# Directory where the JSON files will be saved
save_dir = "CORDEX-CMIP6_driving_source_id"
...
data = fetch_json(json_url)["driving_source_id"]
