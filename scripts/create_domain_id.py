...
save_dir = "CORDEX-CMIP6_domain_id"
...
data = fetch_json(json_url)["domain_id"]

known_sources_in_universe = ev.get_all_terms_in_data_descriptor("region")
print(known_sources_in_universe)
for item in data:
    found_item = None
    for domain in known_sources_in_universe:
